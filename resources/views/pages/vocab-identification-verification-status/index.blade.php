        ...
        @forelse($items as $item)
          <tr>
            ...
            <td style="text-align:right;">
              <a class="btn ghost" href="{{ route('vocab-identification-verification-status.show', $item) }}"><i class="fa fa-eye"></i></a>
              <a class="btn ghost" href="{{ route('vocab-identification-verification-status.edit', $item) }}"><i class="fa fa-edit"></i></a>
