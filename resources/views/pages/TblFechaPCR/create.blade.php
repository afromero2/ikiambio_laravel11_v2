...
<form method="POST" action="{{ route('tbl-fecha-pcr.store') }}" class="card card-body">
  @csrf
  ...
  <div class="form-grid">
    ...
    <div>
      ...
      @error('amplificationDate') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('amplificationMethod') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('lugar_process') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('amplificationStaff') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('num_reacciones') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('volumen_finalRx') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('equipo_PCR') <small class="text-danger">{{ $message }}</small> @enderror
    </div>

    <div>
      <label class="label">Pre c</label>
      <input type="number" name="pre_c" value="{{ old('pre_c', isset($item)? $item->pre_c : '') }}" class="input">
      @error('pre_c') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('pretiempo') <small class="text-danger">{{ $message }}</small> @enderror
    </div>

    <div>
      <label class="label">Pcr1 c</label>
      <input type="number" name="pcr1_c" value="{{ old('pcr1_c', isset($item)? $item->pcr1_c : '') }}" class="input">
      @error('pcr1_c') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('pcr1tiempo') <small class="text-danger">{{ $message }}</small> @enderror
    </div>

    <div>
      <label class="label">Pcr2 c</label>
      <input type="number" name="pcr2_c" value="{{ old('pcr2_c', isset($item)? $item->pcr2_c : '') }}" class="input">
      @error('pcr2_c') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('pcr2tiempo') <small class="text-danger">{{ $message }}</small> @enderror
    </div>

    <div>
      <label class="label">Pcr3 c</label>
      <input type="number" name="pcr3_c" value="{{ old('pcr3_c', isset($item)? $item->pcr3_c : '') }}" class="input">
      @error('pcr3_c') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('pcr3tiempo') <small class="text-danger">{{ $message }}</small> @enderror
    </div>

    <div>
      <label class="label">Post c</label>
      <input type="number" name="post_c" value="{{ old('post_c', isset($item)? $item->post_c : '') }}" class="input">
      @error('post_c') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('imagenPCRAccessionURI') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('imagenPCR') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
  </div>
