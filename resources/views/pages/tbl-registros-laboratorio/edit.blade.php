...
<form method="POST" action="{{ route('tbl-registros-laboratorio.update', $item) }}" class="card card-body">
  ...
  <div class="form-grid">
    ...
    <div>
      ...
      @error('idFechaPCR') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('idExtracciones') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('vol_ADN_PCR') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('amplificationSuccess') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('amplificationSuccessDetails') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('sampleDesignation') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('idPrimerF') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('idPrimerR') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('tecnologia_secuenciacion') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('consensusSequence') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('fechaSecuenciacion') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('sequencingStaff') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('ordenSecuenciacion') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('geneticAccessionNumber') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
    ...
    <div>
      ...
      @error('geneticAccessionURI') <small class="text-danger">{{ $message }}</small> @enderror
    </div>
  </div>

  <div style="margin-top:12px;">
    <button class="btn primary">Actualizar</button>
    <a href="{{ route('tbl-extractions.index',$item) }}" class="btn">Cancelar</a>
  </div>
</form>
@endsection
