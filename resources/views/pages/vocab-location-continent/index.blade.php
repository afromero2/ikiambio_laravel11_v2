        ...
        @forelse($items as $item)
          <tr>
            ...
            <td style="text-align:right;">
              <a class="btn ghost" href="{{ route('vocab-location-continent.show', $item) }}"><i class="fa fa-eye"></i></a>
              <a class="btn ghost" href="{{ route('vocab-location-continent.edit', $item) }}"><i class="fa fa-edit"></i></a>
